...
public class InputAvoidEscapedUnicodeCharacters5 {
    ...
    private String c = "\uD83C\uDF84😀\uD83C\uDF84"; //allowed by trailing comment
    // violation below
    ...
    public Object fooEmoji() {
        ...
        String content = null;
        return "😀" + content + "\u03bc"; /*, allowed by trailing comment */
    }
    ...
    public boolean matches(String c) {
        switch (c) {
            //violation below
            case "\u03bc🎄":
            case "🎄\u03bc": /*, allowed by trailing comment */
                // violation below
            case "\t\u2028":
                // violation below
            case "\n😂\u3000":
            ...
            case "😂\uD83D\uDE02":
                return false;
            default:
                return c.equals("\u2000😂\u2000"); //allowed by trailing comment
        }
    }
}
